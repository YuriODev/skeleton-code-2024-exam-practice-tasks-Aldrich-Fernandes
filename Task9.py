...
class Puzzle():
    def __init__(self, *args):
        if len(args) == 1:
            ...
            count = 0
            while count != 5:
                index = random.randint(0, self.__GridSize * self.__GridSize)
                ...
                try:
                    ...
                    for P in self.__AllowedPatterns:
                        ...
                        if P.MatchesPattern(PatternString, CurrentSymbol):
                            #-----------------------------------------------------------------------#
                            UpdateCells = []
                            UpdateCells.append(self.__GetCell(StartRow, StartColumn))
                            UpdateCells.append(self.__GetCell(StartRow, StartColumn + 1))
                            UpdateCells.append(self.__GetCell(StartRow, StartColumn + 2))
                            UpdateCells.append(self.__GetCell(StartRow - 1, StartColumn + 2))
                            UpdateCells.append(self.__GetCell(StartRow - 2, StartColumn + 2))
                            UpdateCells.append(self.__GetCell(StartRow - 2, StartColumn + 1))
                            UpdateCells.append(self.__GetCell(StartRow - 2, StartColumn))
                            UpdateCells.append(self.__GetCell(StartRow - 1, StartColumn))
                            UpdateCells.append(self.__GetCell(StartRow - 1, StartColumn + 1))
